      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="relative mt-16">
            {/* Timeline Line */}
            <div className="absolute left-[20px] top-0 bottom-0 w-1 bg-gradient-to-b from-primary via-secondary/20 to-primary/10 hidden md:block rounded-full" />
            
            <div className="space-y-10">
              {dates.map((item, i) => (
                <div key={i} className="relative md:pl-16">
                  <div className="absolute left-[-24px] top-1/2 -translate-y-1/2 w-12 h-12 rounded-2xl bg-white border-2 border-primary hidden md:flex items-center justify-center z-10 shadow-lg group">
                    ...
                    <CardContent className="p-8 flex flex-col sm:flex-row sm:items-center justify-between gap-6">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-muted-foreground mt-1">SYNERGY 2026 - IC-SIIT milestone</p>
                        </div>
                      </div>
